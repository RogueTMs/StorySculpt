...
namespace StorySculpt
{
    internal class Program
    {
        ...
        private static void meth(Chat chat)
        {
            Console.WriteLine(chat.getCurrentMessage());
            chat.sendMessage("Иди нахер");
        }
